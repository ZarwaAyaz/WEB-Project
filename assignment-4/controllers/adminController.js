...
const { ADMIN_PASSWORD } = require('../middleware/adminAuth');
...
exports.addProduct = async (req, res) => {
    try {
        ...
        req.session.successMsg = `Product "${name}" added successfully!`;
        res.redirect('/admin');
    } catch (err) {
        console.error(err);
...
exports.editProduct = async (req, res) => {
    try {
        ...
        req.session.successMsg = `Product "${name}" updated successfully!`;
        res.redirect('/admin');
    } catch (err) {
        console.error(err);
...
exports.deleteProduct = async (req, res) => {
    try {
        ...
        req.session.successMsg = `Product "${product.name}" deleted successfully.`;
        res.redirect('/admin');
    } catch (err) {
        console.error(err);
